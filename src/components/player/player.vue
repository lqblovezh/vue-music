                    ...
                    <scroll class="middle-r" ref="lyricList" :data="currentLyric&&currentLyric.lines">
                        <div class="lyric-wrapper">
                            <div v-if="currentLyric">
                                <p ref="lyricLine" :class="{current:currentLineNum===index}" v-for="(item,index) in currentLyric.lines" class="text">{{item.txt}}</p>
                            </div>
                        </div>
                    </scroll>
                </div>
                    ...
                    <div class="operators">
                        ...
                        <div class="icon i-right">
                            <i class="icon" @click="toggleFavorite(currentSong)"
                               :class="getFavoriteItem(currentSong)"></i>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/ecmascript-6">
    ...
    import {playerList} from 'common/js/mixin';
